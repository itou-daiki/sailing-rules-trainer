...
export const ruleChanges: RuleChange[] = [
  {
    ...
    quick: '他艇どうしや、艇と避けるべき物体を接触させることも避ける。',
  ...
  },
  {
    ...
    quick: 'タッキング中にできた重なりにも、規則17がかかる場合がある。',
  ...
  },
  {
    ...
    quick: '長い防波堤などは「最も短い艇の3艇身以上」が判断の目安になった。',
  ...
  },
  {
    ...
    quick: '先にゾーンへ入った艇と、ゾーン内でタックした艇の関係を明確にした。',
  ...
  },
  {
    ...
    quick: '正しくスタートしていなくても、定義上はフィニッシュする場合がある。',
  ...
  },
  {
    ...
    quick: '赤旗が必要なのは艇体長が6mを超える艇。声が届かない場合にも例外がある。',
