...
アプリ内の「中級」は、艇が出会う場面、障害物、安全、違反後、推進、抗議までの規則判断を指します。艇速、操船、風や潮に応じた戦術まで含む総合的なレース技能ではないため、それらは水上練習と指導者のフィードバックで補います。

内容は次の資料を基準に、2026年8月24日に確認しています。
