...
export const quizQuestions: QuizQuestion[] = [
  ...
  // https://media.sailing.org/sailing/wp-content/uploads/2025/07/29083752/2025-2028-RRS-with-Changes-and-Corrections.pdf
  {
    ...
    choices: ['規則31の違反', '接触が軽いので何も起きない', 'マークルームを自動的に得る'],
    correctIndex: 0,
  ...
  },
  {
    ...
    skill: 'penalties',
    difficulty: 1,
    prompt: '規則31に違反してマークへ触れました。通常の回転ペナルティーは？',
    choices: ['1回転', '2回転', '3回転'],
    correctIndex: 0,
  ...
  },
  {
    ...
    skill: 'penalties',
    difficulty: 1,
    prompt: '艇が出会うときのPart 2の規則に違反しました。大会文書に変更がない場合、通常は？',
  ...
  },
  {
    ...
    skill: 'penalties',
    difficulty: 3,
    prompt: 'A艇は権利のあるマークルーム内を帆走中、規則14に違反しましたが損傷も負傷もありません。A艇は？',
    choices: ['規則14について免罪される', '必ず失格になる', 'マークルームを失う'],
    correctIndex: 0,
  ...
  },
  {
    ...
    skill: 'race-conduct',
    difficulty: 2,
    prompt: 'レース中、すべての艇が自由に入手できる気象情報を確認しました。規則41では？',
  ...
  },
  {
    ...
    choices: ['禁止されるロッキング', '規則20の声かけ', 'コース短縮'],
    correctIndex: 0,
  ...
  },
  {
    ...
    skill: 'race-conduct',
    difficulty: 3,
    prompt: 'サーフィングできる波で、波乗りを開始するため帆を1回だけパンプしました。規則42では？',
